...
//     <div className="mt-16 p-1 mx-auto group rounded-full bg-richblack-800 font-bold text-richblack-200 transition-all duration-200 hover:scale-95 w-fit drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] ">
//     <Link to={"/signup"}>
//   <div className='flex flex-row items-center gap-2 rounded-full px-10 py-[5px] transition-all duration-200 group-hover:bg-[#EAF5FF]'>
...
//     <div className='mt-4 mx-auto text-center w-[90%] text-lg font-bold text-richblack-300'>
...
// <div className='w-11/12 max-w-maxContent justify-center  items-center gap-5 flex flex-col mx-auto'>
...
// <h2 className='text-center text-4xl front-semibol mt-10'>Reviews from other learners</h2>
